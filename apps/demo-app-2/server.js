...
const config = {
  ...
  clientId: process.env.KEYCLOAK_CLIENT_ID || 'app-reportes',
  clientSecret: process.env.KEYCLOAK_CLIENT_SECRET || 'reportes-secret-456',
  callbackUrl: process.env.CALLBACK_URL || 'http://localhost:3002/callback'
};
